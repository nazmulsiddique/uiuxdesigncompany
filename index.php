    ...
    <header id="header" class="mxd-header">
      ...
      <div class="mxd-header__logo loading__fade">
        <a href="index-main.html" class="mxd-logo">
          ...
          <!-- logo text -->
          <!-- <span class="mxd-logo__text">UI UX Design<br>Company</span> -->
        </a>
      </div>
      <!-- header controls -->
                ...
                <div class="col-12 col-xl-10 mxd-grid-item no-margin">
                  <div class="mxd-block__content">
                    <div class="mxd-block__manifest">
                      <p class="mxd-manifest reveal-type anim-uni-in-up" style="max-width: 100%;">
Behind every successful brand lies creativity, precision, and a seamless user experience. UI UX Design Company is built on that very belief—to transform your ideas into designs that are not just visually appealing, but emotionally engaging. We believe that great design is not only seen; it’s felt. And that emotional connection is what makes a brand truly unforgettable</p>
        ...
        <div class="footer-blocks__column animate-card-3">
          ...
          <div class="footer-blocks__card">
            <p class="mxd-point-subtitle anim-uni-in-up">
              ...
              <a href="mailto:example@example.com?subject=Message%20from%20your%20site">info@uiuxdesigncompany.com</a>
            </p>
          </div>
          <!-- inner card -->
          <div class="footer-blocks__card">
            <p class="mxd-point-subtitle anim-uni-in-up">
              ...
              <a href="tel:+8801688037772">+8801688037772</a>
            </p>
          </div>
          <!-- inner card -->
          ...
          <div class="footer-blocks__card fullheight-card">
            ...
            <div class="footer-blocks__block">
              ...
              <div class="footer-blocks__socials">
                <ul class="footer-socials">
                  ...
                  <li class="footer-socials__item anim-uni-in-up"><a href="https://www.facebook.com/" class="footer-socials__link" target="_blank">Facebook</a></li>
                  <li class="footer-socials__item anim-uni-in-up"><a href="https://youtube.com/" class="footer-socials__link" target="_blank">Youtube</a></li>
                  <li class="footer-socials__item anim-uni-in-up"><a href="https://linkdub.com/" class="footer-socials__link" target="_blank">Linkdin</a></li>
                </ul>
              </div>
            </div>
            <!-- links -->
            <div class="footer-blocks__links anim-uni-in-up">
              <p class="t-xsmall t-muted">
                <a class="no-effect" href="https://1.envato.market/EKA9WD" target="_blank">UI UX Design Company All Right Resurved</a>
